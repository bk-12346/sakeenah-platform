...
export default function HomeScreen({ onResponse }: Props) {
  ...
  return (
    <div className="animate-fade-in">
      <h2 className="font-display text-2xl mb-6">What's on your mind?</h2>
      ...
      <textarea
        ...
        rows={5}
        className="w-full bg-card border border-border rounded-lg p-4 text-sm font-body leading-relaxed resize-none focus:outline-none focus:ring-2 focus:ring-ring placeholder:text-muted-foreground"
      />
      ...
      <button
        ...
        className="w-full mt-6 py-3 bg-primary text-primary-foreground rounded-full text-sm font-medium disabled:opacity-40 hover:opacity-90 transition-opacity"
      >
        {loading ? (
